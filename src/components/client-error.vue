<template>
  <div class="mybg" >
    ...
    <p class="center">
      ...
      <br/> Используй <span class="label label-danger">пробел</span> что бы стрелять <span class="label label-danger">←</span>&#160;
      <span class="label label-danger">→</span> что бы двигаться!&#160;&#160;&#160;
      <button ref="restartgame" class="btn label label-danger" id="restart" >Restart (enter)</button></p>
      ...
      Game.prototype = {
        ...
        draw: function () {
          ...
          if (this.lost) {
            ...
            screen.fillText("п о т р а ч е н о", gameSize.width / 2, gameSize.height / 2);
